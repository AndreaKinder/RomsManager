...
import AddRomForm from './AddRomForm';

jest.mock('../../back/data/consoles.json', () => ({
  consoles: {
...
describe('AddRomForm', () => {
  ...
  test('renders form with all fields', () => {
    ...
    expect(screen.getByPlaceholderText('e.g., Action, RPG, Platformer...')).toBeInTheDocument();
  ...
  test('calls onSubmit with form data when submitted', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('e.g., Action, RPG, Platformer...'), {
